...
class CamelListPage extends ConsumerStatefulWidget {
  final String type;
  const CamelListPage({
    super.key,
    required this.type,
  ...
  @override
  ConsumerState<CamelListPage> createState() => _MeatListPageState();
}

class _MeatListPageState extends ConsumerState<CamelListPage> {
  int selectedIndex = 0;
