...
class _SearchPageState extends State<SearchPage> {
  ...
  getItems() async {
    ...
    for(int a = 0; a < data.size; a++){
      var data1 = await FirebaseFirestore.instance.collection("meatTypes").doc(data.docs[a]["type"]).collection(data.docs[a]["type"]).get();
      ...
      SingleChildScrollView(
        child: Column(
          children: [
            ...
            filteredItems.isEmpty? Center(child: Text("No Items Found")):
            ListView.builder(
              shrinkWrap: true,
